...
*/
let arr : number[] = [3,8,10] 
let arr1: number[]= [3,5,7]

if(arr>arr1){
    console.log(`First vaule of array is greater then 1st value`) // this is exceute  beacuse all elements in both arrays are not
}
